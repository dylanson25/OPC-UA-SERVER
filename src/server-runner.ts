...
/**
 * @returns the OPCUAServerManager instance, mainly so callers/tests can reach
 * into it (e.g. to call `shutdown()` themselves) without re-wiring anything.
 */
export function startServer(): OPCUAServerManager {
